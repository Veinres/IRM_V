...
%SPECIES generate table of tungsten + argon species reactions
% =========================================================================
...
ch_tran         = {'chexAri'    ,{'Ari','W'}    ,{'Ar','Wi'}        ,2          ,[2e-16]                                ,'ch_trans','WO'};

% >> Penning ionisation ---------------------------------------------------
%                  name         reactants       products            eq_type     coeffs                                  type    source
penning         = {'Pen'        ,{'Arm3P0','W'} ,{'Ar','Wi','e'}    ,2          ,[5.3e-15]                              ,'pen'  ,'WO';...
                   'Pen'        ,{'Arm3P2','W'} ,{'Ar','Wi','e'}	,2          ,[5.3e-15]                              ,'pen'  ,'WO'};
