...
%SPECIES generate table of nitrogen/titanium species reactions
% =========================================================================
% Generate a table containing relevant nitrogen/titanium species reactions.
% =========================================================================
...
if options.loadThorsteinsson
    ...
    ti_spe = material.target.Ti.species().name;
    e_spe = material.electron.species().name;
    must_contain = ti_spe;
    can_only_contain = vertcat(ti_spe, e_spe);
