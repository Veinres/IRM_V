function [filename, output] = sputterYield(species, options)
%SPUTTERYIELD generate sputter yield structure
% =========================================================================
% Generate a structure containing the energy resolved sputter
...
warning('Not implemented yet. Using "create_Yield.m"');
filename = '';
output = struct();

cd pre-cal/Sputter_yield/
[~, output] = create_Yield(species);
cd  ../../
